...
export default function RegistarViatura() {
    ...
    const handleSubmitMarca = (message, severity) => {
        setMessage(message)
        setSeveridade(severity)
        setOpenAlert(true)
    ...
    const handleSubmitModelo = (message, severity) => {
        setMessage(message)
        setSeveridade(severity)
        setOpenAlert(true)
    ...
    const handleSubmitCor = (message, severity) => {
        setMessage(message)
        setSeveridade(severity)
        setOpenAlert(true)
    ...
    const handleSubmitSeguradora = (message, severity) => {
        setMessage(message)
        setSeveridade(severity)
        setOpenAlert(true)
