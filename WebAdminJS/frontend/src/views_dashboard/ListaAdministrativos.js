...
export default function ListaAdministrativos() {
    ...
    useEffect(() => {
        getUrl('user/listaadministrativos')
            .then((res) => {
                if (res.data.success) {
                    setAdministrativos(res.data.data)
                    setUpdate(false)
                } else {
    ...
    return (
        <>
            <TabelasPaginasHeader
                ...
                url="/Dashboard/Administracao/ListarAdministrativos"
            />
