...
export default function ListaAdministradoresOperador() {
    const classes = useStyles()

    const [administradoresOperador, setAdministradoresOperador] = useState([])
    ...
    useEffect(() => {
        getUrl('user/listaadministradoresoperador')
            .then((res) => {
                if (res.data.success) {
                    setAdministradoresOperador(res.data.data)
                    setUpdate(false)
                } else {
    ...
    return (
        <>
            <TabelasPaginasHeader
                ...
                titulo="Administradores do Operador"
                url="/Dashboard/Administracao/ListarAdministradoresOperador"
            />
