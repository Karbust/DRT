...
export default function ListaAdministrativosOperador() {
    ...
    const [administrativosOperador, setAdministrativosOperador] = useState([])
    ...
    useEffect(() => {
        getUrl('user/listaadministrativosoperador')
            .then((res) => {
                if (res.data.success) {
                    setAdministrativosOperador(res.data.data)
                    setUpdate(false)
                } else {
    ...
    return (
        <>
            <TabelasPaginasHeader
                ...
                titulo="Administrativos do Operador"
                url="/Dashboard/Administracao/ListarAdministrativosOperador"
            />
