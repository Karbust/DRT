...
export const TabelasPaginasHeader = (props) => {
    const classes = useStyles()
    const {
        openBackdrop, handleCloseBackdrop, openAlert, handleCloseAlert, severity, message, titulo, url, handleFilter,
    } = props
    return (
        <>
            <Backdrop
...
TabelasPaginasHeader.propTypes = {
